...
class API(ManagerAPI):
    ...
    def create_event(self, event_type,
        ...
        self._cast("create_event", event_type=event_type,
    ...
    def modify_event(self, event_type,
                           volume_size,
                           instance_size,
                           tenant_id,
                           instance_id,
        ...
        #TODO(cp16net): can we pass through kwargs here?
        self._cast("modify_event", event_type=event_type,
                           volume_size=volume_size,
                           instance_size=instance_size,
                           tenant_id=tenant_id,
                           instance_id=instance_id,
    ...
    def delete_event(self, event_type,
        ...
        LOG.debug("Making async call for (%s) usage event for instance: (%s)"
                  % (event_type, instance_id))
        #TODO(cp16net): can we pass through kwargs here?
        self._cast("delete_event", event_type=event_type,
                           volume_size=volume_size,
                           instance_size=instance_size,
                           tenant_id=tenant_id,
                           instance_id=instance_id,
